...
class DailyNewsItemCell: UICollectionViewCell {

    @IBOutlet weak var newsItemImageView: RaveImageView!
    ...
    func configure(with newsitems: DailyNewsModel, ltr: Bool) {
